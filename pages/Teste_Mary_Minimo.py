...
from templates_mary import (
    bloco_template_shopping_donisete,
    bloco_template_reconciliacao,
    bloco_template_joselina,
    bloco_template_diversao,
    bloco_template_safada,
    bloco_template_mary_livre_carente,
)
...
OPENROUTER_MODELS = {
     ...
     "venice-edition": "cognitivecomputations/dolphin-mistral-24b-venice-edition",
...
{regra_camisinha_casual_txt if regra_camisinha_casual_txt else "Nenhuma regra de camisinha casual ativa neste turno."}
